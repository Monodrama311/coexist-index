...
const SUPABASE_URL = 'https://zfrginwphvxkjtdhdzgz.supabase.co';
...
// 检测是否配置完成 + 其他健壮性检查
export const isConfigured = SUPABASE_URL !== 'YOUR_SUPABASE_URL' && SUPABASE_URL.startsWith('https://') && !SUPABASE_URL.endsWith('/rest/v1/');

if (!isConfigured) {
  console.warn('[Coexist] Supabase 未配置或配置不合法,运行在 mock 模式');
}
